/**
 * Compact MD5 (RFC 1321) over bytes → hex. Needed for the Supernote Cloud login
 * hash (sha256(md5(password) + randomCode)); WebCrypto has no MD5.
